...
export const ERROR_DEFINITIONS: Record<ErrorCode, ErrorCodeMetadata> = {
	...
	[ErrorCode.JOB_NOT_FOUND]: {
		...
		defaultMessage: 'Job not found or access denied',
		httpStatus: 404,
		isRetryable: false,
		category: 'resource',
	},
	[ErrorCode.JOB_ALREADY_EXISTS]: {
		code: ErrorCode.JOB_ALREADY_EXISTS,
		defaultMessage: 'A job is already in progress for this request',
		httpStatus: 409,
		isRetryable: false,
		category: 'resource',
	},
	[ErrorCode.JOB_CANCELLED]: {
		...
		defaultMessage: 'Job was cancelled',
		httpStatus: 410,
		isRetryable: false,
		category: 'resource',
	},
	[ErrorCode.JOB_EXPIRED]: {
		...
		defaultMessage: 'Job has expired',
		httpStatus: 410,
		isRetryable: true,
		category: 'resource',
	},
	[ErrorCode.JOB_TIMEOUT]: {
		...
		defaultMessage: 'Job processing timed out',
		httpStatus: 504,
		isRetryable: true,
		category: 'internal',
	},
	[ErrorCode.QUEUE_SEND_FAILED]: {
		code: ErrorCode.QUEUE_SEND_FAILED,
		defaultMessage: 'Failed to queue job for processing',
		httpStatus: 503,
		isRetryable: true,
		category: 'internal',
	},
