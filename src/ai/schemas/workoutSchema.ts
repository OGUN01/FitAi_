      ...
      items: {
        ...
        properties: {
          exerciseId: {
            ...
            description: "🚨 MANDATORY: Exact 7-character alphanumeric exercise ID from the provided exercise database (e.g., 'VPPtusI', '8d8qJQI'). Must contain at least one uppercase letter. DO NOT create new IDs or use descriptive names like 'push_ups' or 'dynamic_elevators'. MUST be from the provided exercise list only."
          },
          name: {
            type: "string",
            description: "Display name for the exercise - can be creative (e.g., 'Power Push-ups', 'Core Crusher Squats')"
          },
          description: {
            type: "string",
        ...
        required: [
          "exerciseId", "name", "description", "muscleGroups", "equipment", "sets", 
            ...
            items: {
              ...
              properties: {
                exerciseId: { 
                  type: "string",
                  pattern: "^[A-Za-z0-9]*[A-Z][A-Za-z0-9]*$",
                  description: "🚨 CRITICAL: Must be exact 7-character database ID from provided exercise list (format: alphanumeric like 'VPPtusI'). Must contain at least one uppercase letter. Never use descriptive names like 'mountain_climbers' or 'dynamic_elevators'. Copy exact ID from exercise database." 
                },
                name: { type: "string", description: "Display name for the exercise (can be creative)" },
