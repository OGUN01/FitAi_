  ...
  properties: {
    foods: {
      ...
      items: {
        ...
        required: [
          "name", "category", "cuisine", "estimatedGrams", "calories", 
          "protein", "carbs", "fat", "fiber", "confidence"
        ]
      }
    },
    overallConfidence: {
  ...
  properties: {
    meals: {
      ...
      items: {
        ...
        required: [
          "name", "description", "type", "cuisine", "prepTime", "cookTime", 
...
export const RECIPE_CREATION_SCHEMA = {
  ...
  required: [
    ...
    "difficulty", "ingredients", "instructions", "nutritionPerServing"
  ]
};