  ...
  return (
    <View style={[styles.container, style]}>
      ...
      <View style={styles.legend}>
        <Text style={styles.legendTitle}>Heart Rate Zone Guide:</Text>
        <View style={styles.legendGrid}>
          <Text style={styles.legendItem}>Zone 1: Warm-up (50-60%)</Text>
          <Text style={styles.legendItem}>Zone 2: Fat Burn (60-70%)</Text>
          <Text style={styles.legendItem}>Zone 3: Cardio (70-80%)</Text>
          <Text style={styles.legendItem}>Zone 4: Hard (80-90%)</Text>
          <Text style={styles.legendItem}>Zone 5: Max (90-100%)</Text>
        </View>
      </View>
    </View>
  );
