...
const mealTypeGradients: Record<
  string,
...
export const PremiumMealCard: React.FC<PremiumMealCardProps> = memo(
  ({
    meal,
    mealTime,
    onPress,
              ...
              <View style={styles.headerRow}>
                ...
                <View style={styles.titleContainer}>
                  ...
                  <View style={styles.typeRow}>
                    <Text
                      style={[styles.mealType, { color: mealConfig.colors[0] }]}
                    >
              ...
              <View style={styles.nutritionRow}>
                ...
                <View style={styles.macroRingsContainer}>
                  ...
                  <View style={styles.macroRingItem}>
                    ...
                    <Text
                      style={[styles.macroLabel, { color: macroColors.carbs }]}
                    >
                      Carbs
                    </Text>
                  </View>
                  ...
                  <View style={styles.macroRingItem}>
                    ...
                    <Text
                      style={[styles.macroLabel, { color: macroColors.fat }]}
                    >
                      Fat
                    </Text>
                  </View>
                ...
                {onCompleteMeal && (
                  ...
                  >
                    ...
                    >
                      <Ionicons
                        name={
                          isCompleted ? "checkmark-circle" : "checkbox-outline"
                        }
                        size={rf(18)}
                        color={colors.text.primary}
                      />
