/**
 * ChartCallout — the 2026 charts-kit selection callout.
 *
 * Replaces ui/ChartTooltip (old chart-set member): flat surface + hairline
 * border, tabular-nums metric readout, no cast-shadow stack — separation
 * comes from the hairline, per Editorial Dark. Same props contract as the
 * retired tooltip so consumers migrate mechanically.
 */
...
export const ChartCallout: React.FC<ChartCalloutProps> = ({
  visible,
  x,
  y,
  value,
