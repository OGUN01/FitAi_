    ...
    <View style={styles.container}>
          ...
          {warning.risks && warning.risks.length > 0 && (
            <View style={styles.risksContainer}>
              <View style={styles.riskHeader}>
                <Ionicons name="warning-outline" size={rf(12)} color="#F97316" />
                <Text style={styles.risksTitle}>Risks</Text>
              </View>
              {warning.risks.map((risk, i) => (
                <Text key={i} style={styles.riskText}>• {risk}</Text>
              ))}
            </View>
          )}
      ...
      >
        <Animated.View style={[
          ...
          {acknowledged && <Ionicons name="checkmark" size={rf(14)} color="#fff" />}
        </Animated.View>
