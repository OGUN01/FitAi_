...
const generateRecommendations = (
  ...
  if (recoveryScore !== undefined && recoveryScore >= 80) {
    recommendations.push({
      ...
      description:
        "Your recovery score is excellent. Perfect day for HIIT or strength training.",
      action: "Start Workout",
      priority: 1,
    });
  } else if (recoveryScore !== undefined && recoveryScore >= 60) {
    recommendations.push({
      id: "moderate-workout",
      type: "workout",
      title: "Balanced Training Day",
      description:
        "Moderate recovery suggests a steady-state cardio or yoga session.",
      action: "View Options",
      priority: 2,
    });
  } else if (recoveryScore !== undefined && recoveryScore < 50) {
    recommendations.push({
      id: "rest-day",
      type: "recovery",
  ...
  if (
    ...
    caloriesConsumed < caloriesGoal * 0.3
  ) {
    recommendations.push({
      ...
      description:
        "Start with a protein-rich breakfast to maintain energy levels.",
      action: "Meal Ideas",
      priority: 2,
    });
  }
