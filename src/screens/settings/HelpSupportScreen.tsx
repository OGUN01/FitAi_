    ...
    setFaqs(prev => 
      prev.map(faq => 
        faq.id === id 
          ...
          : { ...faq, expanded: false } // Close others
      )
    );
  };
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Card style={styles.resourceCard} variant="outlined">
            <TouchableOpacity onPress={() => Alert.alert('User Guide', 'Comprehensive user guide will be available soon!')}>
          ...
          <Card style={styles.resourceCard} variant="outlined">
            <TouchableOpacity onPress={() => Alert.alert('Video Tutorials', 'Video tutorials will be available soon!')}>
              <View style={styles.resourceContent}>
                <Text style={styles.resourceIcon}>🎥</Text>
                <View style={styles.resourceInfo}>
            ...
            <TouchableOpacity onPress={handleCommunity}>
              <View style={styles.resourceContent}>
                ...
                <View style={styles.resourceInfo}>
                  ...
                  <Text style={styles.resourceDescription}>
                    Connect with other FitAI users
                  </Text>
                </View>
                <Text style={styles.resourceArrow}>›</Text>
              </View>
          ...
          <Card style={styles.resourceCard} variant="outlined">
            <TouchableOpacity onPress={() => Alert.alert('System Status', 'System status page will be available soon!')}>
              <View style={styles.resourceContent}>
                <Text style={styles.resourceIcon}>⚡</Text>
                <View style={styles.resourceInfo}>
          ...
          <Card style={styles.contactCard} variant="outlined">
            <View style={styles.contactContent}>
              ...
              <View style={styles.contactMethods}>
                ...
                <TouchableOpacity 
                  style={styles.contactMethod}
                  onPress={() => Alert.alert('Phone Support', 'Phone support will be available soon!')}
                >
