      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <Animated.View entering={FadeIn.duration(300)} style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            <Ionicons name="information-circle-outline" size={rf(18)} color={ResponsiveTheme.colors.primary} />
        ...
        >
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Ionicons name="star-outline" size={rf(14)} color={ResponsiveTheme.colors.textSecondary} />
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Ionicons name="thumbs-up-outline" size={rf(14)} color={ResponsiveTheme.colors.textSecondary} />
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Ionicons name="logo-buffer" size={rf(14)} color={ResponsiveTheme.colors.textSecondary} />
            ...
            >
              ...
              >
                <GlassCard elevation={1} padding="md" blurIntensity="light" borderRadius="lg" style={styles.socialButton}>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Ionicons name="document-outline" size={rf(14)} color={ResponsiveTheme.colors.textSecondary} />
            ...
            <ActionItem
              ...
              onPress={() => Alert.alert('Open Source', 'Open source licenses will be displayed here.')}
              animationDelay={900}
            />
          </View>
