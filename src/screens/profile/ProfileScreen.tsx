...
const ProfileScreenInternal: React.FC<{ navigation?: any }> = ({
  ...
  // Memoize initializeSubscription for stable reference
  const initializeSubscriptionMemo = React.useCallback(() => {
    initializeSubscription();
  }, [initializeSubscription]);

  // Initialize subscription system
  useEffect(() => {
    initializeSubscriptionMemo();
  }, [initializeSubscriptionMemo]);
  ...
  }, [stat1Count, stat2Count, stat3Count, stat4Count]);
