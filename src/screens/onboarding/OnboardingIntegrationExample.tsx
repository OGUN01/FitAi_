...
export const OnboardingIntegrationExample: React.FC<OnboardingIntegrationExampleProps> = ({
  onComplete,
}) => {
  ...
  const handlePersonalInfoSubmit = async (personalInfo: PersonalInfo) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        Alert.alert('Error', result.error || 'Failed to save personal information');
      }
    } catch (error) {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.description}>
          You can now access all features of the app with your personalized experience.
        </Text>
      </View>
    );
  }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.instructions}>
        ...
        <Text style={styles.instructionsText}>
          1. Replace mock data saving in PersonalInfoScreen with handlePersonalInfoSubmit
        </Text>
        <Text style={styles.instructionsText}>
