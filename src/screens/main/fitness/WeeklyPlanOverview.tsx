...
export const WeeklyPlanOverview: React.FC<WeeklyPlanOverviewProps> = ({
  ...
  const stats = useMemo(() => {
    ...
    const totalCalories = (plan as any).totalEstimatedCalories || 0;
    const restDays = (plan as any).restDays?.length || 0;
    ...
    return {
      ...
      totalCalories,
      restDays,
      progressPercent: totalWorkouts > 0 
  ...
  return (
    <Animated.View entering={FadeInDown.delay(300).duration(400)}>
      <GlassCard elevation={2} blurIntensity="light" padding="md" borderRadius="xl">
        {/* Header */}
            ...
            return (
              ...
              >
                ...
                <View style={[
                  ...
                  status.isToday && !status.isSelected && styles.dayCircleToday,
                ]}>
                  {status.isCompleted ? (
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statDivider} />
          <View style={styles.statItem}>
            <Text style={[styles.statValue, { color: ResponsiveTheme.colors.primary }]}>
