...
export const EmptyPlanState: React.FC<EmptyPlanStateProps> = ({
  ...
  return (
    <Animated.View entering={FadeInDown.delay(200).duration(500)}>
      <GlassCard elevation={3} blurIntensity="light" padding="xl" borderRadius="xl">
        <View style={styles.container}>
          ...
          <View style={styles.previewContainer}>
            ...
            <View style={styles.previewRow}>
              <View style={styles.previewItem}>
                <Ionicons name="calendar-outline" size={rf(16)} color="#667eea" />
                <Text style={styles.previewText}>{planDetails.workouts} workouts</Text>
              </View>
              <View style={styles.previewItem}>
          ...
          <View style={styles.featuresContainer}>
            {[
              { icon: 'checkmark-circle', text: '100% GIF video demonstrations' },
              { icon: 'checkmark-circle', text: 'Exercise validation & safety checks' },
              { icon: 'checkmark-circle', text: 'AI-optimized for your equipment' },
            ].map((feature, index) => (
          ...
          >
            <LinearGradient
              colors={isGenerating ? ['#6b7280', '#4b5563'] : ['#667eea', '#764ba2']}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
            ...
            >
              {isGenerating ? (
                <>
                  ...
                  <Text style={styles.generateButtonText}>Finding best exercises for you...</Text>
                </>
              ) : (
                <>
