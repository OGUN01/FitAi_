...
const QUOTES = {
  morning: [
    ...
    { text: "Make it count", subtext: "Every rep brings you closer to your goals" },
    { text: "Own the morning", subtext: "Discipline is the bridge to your dreams" },
  ],
  afternoon: [
    { text: "Stay focused", subtext: "Halfway there, maintain your momentum" },
    { text: "Push through", subtext: "Discomfort is temporary, results are lasting" },
    { text: "No excuses", subtext: "Progress happens outside your comfort zone" },
  ],
  evening: [
    { text: "Finish strong", subtext: "End your day with purpose" },
    { text: "Recover well", subtext: "Rest is when your body rebuilds stronger" },
...
export const MotivationBanner: React.FC<MotivationBannerProps> = ({ onPress }) => {
  ...
  return (
    <AnimatedPressable onPress={onPress} scaleValue={0.98} hapticFeedback={true} hapticType="light" style={styles.container}>
