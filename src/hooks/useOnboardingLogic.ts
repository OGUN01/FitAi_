  ...
  const handleCompletionGetStarted = useCallback(async () => {
    ...
    if (__DEV__) {
      ...
      console.log(
        ...
        '\n🎯🎯🎯 ================================================== 🎯🎯🎯\n',
        '\n===== 📋 PERSONAL INFO (PII redacted) =====',
        // PII (name, age, gender, country/state) intentionally not logged.
        ...
        // Sensitive health data (medical_conditions, medications,
        // pregnancy_status) intentionally not logged.
