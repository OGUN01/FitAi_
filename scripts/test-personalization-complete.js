...
async function testScenario3_Breastfeeding() {
  ...
  logInfo(
    "Expected: Moderate intensity, hydration reminders, avoid excessive compression",
  );
...
async function runAllTests() {
  ...
  log(
    "Testing: Medical Conditions, Pregnancy, Breastfeeding, Workout Time",
    "magenta",
  );
  ...
  results.push({
    name: "Scenario 1: Medical Conditions",
    passed: await testScenario1_MedicalConditions(),
  });
  results.push({
    name: "Scenario 2: Pregnancy (2nd Trimester)",
    passed: await testScenario2_Pregnancy(),
  });
  results.push({
    name: "Scenario 3: Breastfeeding",
    passed: await testScenario3_Breastfeeding(),
  });
  results.push({
    name: "Scenario 4: Morning Workout",
    passed: await testScenario4_MorningWorkout(),
  });
  results.push({
    name: "Scenario 5: Evening Workout",
    passed: await testScenario5_EveningWorkout(),
  });
